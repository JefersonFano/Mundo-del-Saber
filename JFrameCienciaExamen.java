...
public class JFrameCienciaExamen extends javax.swing.JFrame {
    ...
    public JFrameCienciaExamen(JFrameCiencia padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(ecn.getPregunta(posicion));
        String[] a = ecn.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenCiencia ecn = new ExamenCiencia();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(ecn.getRespuesta(i))) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameCienciaExamen(new JFrameCiencia()).setVisible(true);
            }
        });
    }
