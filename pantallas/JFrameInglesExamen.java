...
import evaluacion.ExamenIngles;
 ...
 * @author USER
 */
public class JFrameInglesExamen extends javax.swing.JFrame {

    private JFrameIngles padre;

    /**
     * Creates new form JFrameInglesExamen
     */
    public JFrameInglesExamen(JFrameIngles padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(examenI.getPregunta(posicion));
        String[] a = examenI.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenIngles examenI = new ExamenIngles();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(examenI.getRespuesta(i))) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Evaluación de Inglés");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameInglesExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameInglesExamen(new JFrameIngles(
