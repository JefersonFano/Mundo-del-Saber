...
import evaluacion.ExamenHistoria;
 ...
 */
public class JFrameHistoriaExamen extends javax.swing.JFrame {

    private JFrameHistoria padre;

    /**
     * Creates new form JFrameHistoriaExamen
     */
    public JFrameHistoriaExamen(JFrameHistoria padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(examenH.getPregunta(posicion));
        String[] a = examenH.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenHistoria examenH = new ExamenHistoria();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(examenH.getRespuesta(i))) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Evaluación de Historia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameHistoriaExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameHistoriaExamen(new JFrameHistoria(
