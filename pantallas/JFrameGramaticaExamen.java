...
import evaluacion.ExamenGramatica;
 ...
 */
public class JFrameGramaticaExamen extends javax.swing.JFrame {

    private JFrameGramatica padre;

    /**
     * Creates new form JFrameGramaticaExamen
     */
    public JFrameGramaticaExamen(JFrameGramatica padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(examenG.getPregunta(posicion));
        String[] a = examenG.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenGramatica examenG = new ExamenGramatica();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(examenG.getRespuesta(i))) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Evaluación de Gramática");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameGramaticaExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameGramaticaExamen(new JFrameGramatica(
