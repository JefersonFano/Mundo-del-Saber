...
import evaluacion.ExamenCiencia;
 ...
 */
public class JFrameCienciaExamen extends javax.swing.JFrame {

    private JFrameCiencia padre;

    /**
     * Creates new form JFrameCienciaExamen
     */
    public JFrameCienciaExamen(JFrameCiencia padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(examenC.getPregunta(posicion));
        String[] a = examenC.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenCiencia examenC = new ExamenCiencia();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(examenC.getRespuesta(i))) {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Evaluación de Ciencia");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameCienciaExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameCienciaExamen(new JFrameCiencia(
