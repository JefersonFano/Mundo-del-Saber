...
public class JFrameHistoriaExamen extends javax.swing.JFrame {
    ...
    /**
     * Creates new form JFrameOfimaticaExamen
     */
    public JFrameHistoriaExamen(JFrameHistoria padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(eo.getPregunta(posicion));
        String[] a = eo.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenHistoria eo = new ExamenHistoria();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(eo.getRespuesta(i))) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameHistoriaExamen(new JFrameHistoria()).setVisible(true);
            }
        });
    }
