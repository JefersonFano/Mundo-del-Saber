...
public class JFrameInglesExamen extends javax.swing.JFrame {
    ...
    public JFrameInglesExamen(JFrameIngles padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(ei.getPregunta(posicion));
        String[] a = ei.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenIngles ei = new ExamenIngles();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(ei.getRespuesta(i))) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameInglesExamen(new JFrameIngles()).setVisible(true);
            }
        });
    }
