 ...
 */
public class ExamenComunicacion extends Examen {

    String[] preguntasComunicacion = {
    ...
    public String getRespuesta(int posicion) {
        return respuestasComunicacion[posicion];
    }
    ...
    public String getPregunta(int posicion) {
        return preguntasComunicacion[posicion];
    }
}
