...
import evaluacion.ExamenComunicacion;
 ...
 */
public class JFrameComunicacionExamen extends javax.swing.JFrame {

    private JFrameComunicacion padre;

    /**
     * Creates new form JFrameComunicacionExamen
     */
    public JFrameComunicacionExamen(JFrameComunicacion padre) {
        initComponents();
        transparencia();
        lblPregunta.setText(ec.getPregunta(posicion));
        String[] a = ec.setRespuestas(posicion);
    ...
    int posicion = 0;
    ExamenComunicacion ec = new ExamenComunicacion();
    Object[] select = {"", "", "", "", "", "", "", "", "", ""};
    ...
    public void calificar() {
        ...
        for (int i = 0; i < 10; i++) {
            if (select[i].equals(ec.getRespuesta(i))) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameComunicacionExamen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameComunicacionExamen(new JFrameComunicacion()).setVisible(true);
            }
        });
    }
