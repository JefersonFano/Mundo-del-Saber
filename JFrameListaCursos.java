...
public class JFrameListaCursos extends javax.swing.JFrame {
     ...
     */
    public JFrameListaCursos(JFrameMenuPrincipal padre) {
        initComponents();
        llenarTabla1();
        transparencia();
        this.padre = padre;
    ...
    private void llenarTabla1() {
        ...
        for (Materia materia : Materia.materias) {
            model.addRow(new Object[]{materia.getNombre(),
                materia.getCodigo(), materia.getProfesor(),
                materia.getHoras()});
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Cursos de la plataforma");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameListaCursos(new JFrameMenuPrincipal()).setVisible(true);
            }
        });
    }
